  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Tu pago no pudo ser procesado. No se ha cobrado nada. Intenta nuevamente para acceder al entrenamiento de Swing Trading." />
      </Head>
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <p className={styles.description}>
            Tu pago para el entrenamiento de <strong>Swing Trading</strong> no pudo ser procesado. 
          ...
          <div className={styles.help}>
            ...
            <a href="mailto:soporte@lozanonahuel.com?subject=Consulta%20pago%20Swing%20Trading" className={styles.contactLink}>
              Contactar Soporte
            </a>
          </div>
        </div>
