...
const SubscriberView: React.FC<{ faqs: FAQ[] }> = ({ faqs }) => {
  ...
  const CommunityChat = React.memo(() => {
    ...
    const [message, setMessage] = useState(() => {
      if (typeof window !== 'undefined') {
        const savedMessage = localStorage.getItem('trader-call-chat-draft');
        return savedMessage || '';
      }
      return '';
    });
    ...
    const fetchMessages = async () => {
      ...
      try {
        ...
        if (currentMessage.trim()) {
          localStorage.setItem('trader-call-chat-draft', currentMessage);
        }
      ...
      if (message.trim()) {
        try {
          ...
          if (response.ok) {
            ...
            setMessage('');
            localStorage.removeItem('trader-call-chat-draft');
            setIsTyping(false);
            ...
            <div className={styles.inputContainer}>
              <textarea
                ...
                onChange={(e) => {
                  ...
                  if (newValue.trim()) {
                    localStorage.setItem('trader-call-chat-draft', newValue);
                  } else {
                    localStorage.removeItem('trader-call-chat-draft');
                  }
          ...
          <div className={styles.modalBody}>
            ...
            <div className={styles.inputGroup}>
              ...
              <select
                ...
                disabled={newAlert.esOperacionHistorica} // Deshabilitar para históricas
              >
  ...
  return (
    <div className={styles.subscriberView}>
      ...
      <SubscriptionBanner service="TraderCall" />
